      ...
      <AnimatePresence mode="popLayout">
        {displayKey && (
          <motion.div
            ...
            className="absolute flex items-center justify-center rounded-lg px-4 py-2 font-mono text-2xl font-black text-white/90"
          >
            <motion.span
...
export const Keypad = () => {
  return (
    <div className="h-full w-fit rounded-xl bg-[#2c2c2e] p-1 shadow-sm ring-1 shadow-black ring-white/10">
      {/* Function Row */}
      <Row>
        <Key
          keyCode="Escape"
        ...
        <Key containerClassName="rounded-tr-xl" className="rounded-tr-lg">
          <div className="h-4 w-4 rounded-full bg-gradient-to-b from-[#1a1a1c] via-[#2c2c2e] to-[#1a1a1c] p-px">
  ...
  return (
    <div className={cn("rounded-[4px] p-[0.5px]", containerClassName)}>
      <button
        ...
        className={cn(
          "flex h-6 w-6 cursor-pointer items-center justify-center rounded-[3.5px] bg-[#121212] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.8),0px_1px_1px_0px_rgba(0,0,0,0.5),0px_1px_0px_0px_rgba(255,255,255,0.03)_inset] transition-transform duration-75 active:scale-[0.98]",
          isPressed &&
            "scale-[0.98] bg-[#1a1a1a] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.8),0px_1px_1px_0px_rgba(0,0,0,0.3),0px_1px_0px_0px_rgba(255,255,255,0.01)]",
          className,
        )}
      >
        <div
          className={cn(
            "flex h-full w-full flex-col items-center justify-center text-[5px] text-neutral-400",
            childrenClassName,
          )}
        >
          {children}
  ...
  return (
    <div className={cn("rounded-[4px] p-[0.5px]", containerClassName)}>
      <button
        ...
        onMouseLeave={handleMouseLeave}
        className={cn(
          "flex h-6 w-6 cursor-pointer items-center justify-center rounded-[3.5px] bg-[#121212]/80 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.8),0px_1px_1px_0px_rgba(0,0,0,0.5),0px_1px_0px_0px_rgba(255,255,255,0.03)_inset] transition-transform duration-75 active:scale-[0.98]",
          isPressed &&
            "scale-[0.98] bg-[#1a1a1a] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.8),0px_1px_1px_0px_rgba(0,0,0,0.3),0px_1px_0px_0px_rgba(255,255,255,0.01)]",
          className,
        )}
      >
        <div className="flex h-full w-full flex-col items-start justify-between p-1 text-[5px] text-neutral-400">
          {children}
        </div>
      </button>
    </div>
